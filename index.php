	  ...
	  <h3>About Us</h3>
	   ...
	   <div class="container">		  
		 <div class="col-md-4 about-grids">
			 <h4>Our Vision</h4>
			 <p>Fun Life with Safety....</p>
		 </div>
		 <div class="col-md-4 about-grids grid2">
			 <h4>Our Mission</h4>
			 <p>We are committed to providing you with all the facilities you need to enjoy your leisure time with a range of aesthetic experiences.</p>
		 </div>
		 <div class="col-md-4 about-grids">
			 <h4>Safety Information</h4>
			 <p>We are responsible for your safety and protection and you too must be vigilant.</p>
		 </div>
	 </div>
</div>
<!--/About-->
...
<div id="portfolio" class="portfolio">
   <div class="top-tours-head text-center">
	      ...
	      <ul id="filters" class="clearfix wow bounceIn" data-wow-delay="0.4s">
			...
			<li><span class="filter" data-filter="app">Domestic boat Travel</span></li>
			<li><span class="filter" data-filter="card">Foreign boat Travel</span></li>
			<li><span class="filter" data-filter="icon">Short Date boat Tour</span></li>
			<li><span class="filter" data-filter="fun">Long Date boat Tour</span></li>
	        </ul>
